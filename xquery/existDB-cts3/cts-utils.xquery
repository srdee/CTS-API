...
declare function cts-utils:getWriteableCollectionPath() as xs:string {
	concat('/db/repository/',$cts-utils:writeableCollection) 
};
...
:)
declare function cts-utils:getWriteableInventoryCollectionPath($a_inv as xs:string) as xs:string {
	concat(cts-utils:getWriteableCollectionPath(), '/', $a_inv)
};
...
:)
declare function cts-utils:getWriteableInventoryFilename($a_inv as xs:string) as xs:string {
	concat($cts-utils:writeableCollection,'-inventory-',$a_inv,".xml")
};
...
:)
declare function cts-utils:getWriteableInventoryPath($a_inv as xs:string) as xs:string {
	concat(cts-utils:getWriteableInventoryCollectionPath($a_inv),
...
:)
declare function cts-utils:getWriteableTextPath($a_inv as xs:string) as xs:string {
	concat(cts-utils:getWriteableCollectionPath(), '/', $a_inv, 
				  '/',$cts-utils:writeableCollection,'-text-',$a_inv,".xml")
};
